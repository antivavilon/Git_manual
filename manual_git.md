...
* Так как ветки *discription* в этом проекте до этого не было, а она должна попасть обратно на наш репозиторий на github.com, а затем и к конечному получателю, то мы выполняем следующую команду

...
###***git clone*** *add origin (копируем ссылку на реп, на github.com )*. И меняем в последнй сьроке паку в конце на название склонированного репозитория (именно так будет называться появившаяся пака) с помощью команды ***cd***. Проект готов к работе.
...
* Убедившись, что мы находимся на ветке"description", мы создаем файл в папке *readme.txt*. В тексте описываем проект и свои изменения. Сохраняем иззменеия CTRL+S. И делаем команду.
###***git status***
